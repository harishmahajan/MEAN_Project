...
exports.updateUser = function(req, res){
  register.update({
    "_id": req.body.uid}, 
  {$set: {"_id":  req.body.uid,"username": req.body.datas.username,"mail": req.body.datas.mail,"contact":req.body.datas.contact,"dob":req.body.datas.dob,"gender":req.body.datas.gender}}, {upsert:true},function(err,userData){
    if(userData !== null){
      res.json({
        "code": 200,
        "status": "success",
